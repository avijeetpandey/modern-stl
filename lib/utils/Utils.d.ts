declare const swap: (first: any, second: any) => void;
...
declare const isPrime: (number: Number) => void;
...
export { isAlphaNumeric, isEven, isConsonant, isLeapYear, isMultipleOf, isOdd, isPerfectSquare, isPowerOf, isPrime, isVowel, max, min, square, swap, accumulate, reverse_till, distance, };
